...
function ResetPasswordContent() {
    ...
    const handleSubmit = async (password: string, passwordConfirmation: string) => {
        ...
        try {
            ...
            showToast(res.message || "Contraseña actualizada. Inicia sesión de nuevo.", "success")
            ...
            <div className="w-full max-w-sm">
                <Card className="overflow-hidden">
                    <CardContent className="px-8 py-6">
                        ...
                        <AuthLinkStatus
                            status={status}
                            expiredMessage="Este enlace ya no es válido o expiró. Solicita uno nuevo para restablecer tu contraseña."
                        >
                            <PasswordResetForm
