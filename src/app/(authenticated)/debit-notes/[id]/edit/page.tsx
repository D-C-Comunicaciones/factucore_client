...
export default function DebitNoteEditPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto py-6 sm:py-10 px-4 sm:px-6">
            <Link href={`/debit-notes/${id}`} className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-primary transition-colors mb-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex flex-col sm:flex-row gap-2 mt-6">
                    ...
                    <Link href={`/debit-notes/${id}`} className="w-full sm:w-auto">
