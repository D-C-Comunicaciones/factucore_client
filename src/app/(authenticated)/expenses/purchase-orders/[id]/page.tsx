...
import { InternalPurchaseOrderDetailView } from "@/components/purchase-order/internal/InternalPurchaseOrderDetailView";

export default function InternalPurchaseOrderDetailPage() {
  ...
  return <InternalPurchaseOrderDetailView purchaseOrder={purchaseOrder} />;
}
