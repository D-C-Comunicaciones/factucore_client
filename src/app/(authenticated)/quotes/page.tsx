...
export default function QuotesPage({ onNavigate }: FacturasVentaViewProps) {
    ...
    /* ===================== FETCH ===================== */
    const { data, isLoading, isFetching, isError, refetch } = useQuotesList({
        params,
        enabled: true,
        fetchKey
    });
    ...
    const quotes: QuoteSummary[] = data?.quotes ?? [];
    ...
    return (
        <div className="w-full min-h-screen">
            <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
                ...
                <QuotePageHeader onNavigate={onNavigate} />
