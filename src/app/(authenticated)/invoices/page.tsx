    ...
    return (
        <div className="w-full min-h-screen">
            <div className="w-full max-w-[1200px] mx-auto px-6 md:px-8">
                ...
                {/* Título y acciones */}
                <div>
                    <h1 className="text-lg md:text-xl font-bold mb-2">Facturas de venta</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <div className="text-xs text-gray-600">Sin emisión</div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <div className="text-xs text-gray-600">Sin envío al cliente</div>
                                <div className="text-lg font-bold">0</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table className="w-full min-w-[800px] text-xs">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left font-medium text-gray-700">Creación</th>
                                    ...
                                    <th className="px-4 py-3 text-left font-medium text-gray-700">Por cobrar</th>
                                    <th className="px-4 py-3 text-left font-medium text-gray-700">Estado DIAN</th>
                            ...
                            <tbody>
                                <tr className="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 text-gray-900">LTCH1</td>
                                    <td className="px-4 py-3 text-gray-900">Consumidor Final</td>
                                    <td className="px-4 py-3 text-gray-600">27/01/2025</td>
                                    <td className="px-4 py-3 text-gray-600">27/01/2025</td>
                                    <td className="px-4 py-3 text-gray-900 font-medium">$ 840</td>
