...
export function useRemissionBuilder() {
    ...
    // --- Final Payload Builder matching the remission JSON contract ---
    const buildPayload = (data: any) => {
        // 1. Settings object
        const settings: Record<string, any> = {
            type_remission_id: Number(data.type_remission_id) || 1,
            currency_id: 35
        };
        ...
        // 2. Remission Information object
        ...
        // Construct payload strictly matching the remission JSON contract
        const payload: any = {
            settings,
            remission_information,
            items: payloadItems
        };
