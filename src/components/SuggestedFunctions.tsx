...
export function SuggestedFunctions() {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-lg p-6 flex items-start gap-6">
        <div className="flex-1">
          <div className="space-y-3 mb-4">
            {suggestedFunctions.map((func, idx) => (
              <div key={idx} className="flex items-center gap-2">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                  func.completed ? 'bg-teal-500 border-teal-500' : 'border-gray-300'
                }`}>
                  {func.completed && (
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm min-w-[300px]">
          ...
          <button className="w-full bg-teal-500 hover:bg-teal-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2">
            Registrar saldos
