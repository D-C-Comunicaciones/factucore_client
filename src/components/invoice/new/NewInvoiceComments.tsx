            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${
                  (editorRef.current?.innerText?.trim() || newCommentHtml.includes('<img')) ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'bg-slate-200 text-white cursor-not-allowed'
                }`}
              >
