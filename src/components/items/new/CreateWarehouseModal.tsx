    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="px-6 py-4 border-b border-border/40">
          <DialogTitle className="text-base font-bold text-primary">Nueva bodega</DialogTitle>
        </DialogHeader>
        ...
        <div className="px-6 py-4 border-t border-border/40 bg-[#f8fafc] flex justify-end gap-3 rounded-b-2xl">
          <button
            ...
            className="px-5 py-2 border border-border/60 hover:bg-muted text-foreground text-sm font-bold rounded-xl transition-all"
          >
            Cancelar
          </button>
          <button
