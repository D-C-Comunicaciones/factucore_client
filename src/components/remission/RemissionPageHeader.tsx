...
import { RemissionExportModal } from "./RemissionExportModal";
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
        ...
        <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
                Crea y gestiona remisiones para respaldar los envíos y agilizar tu facturación. <Link href="#" className="text-primary hover:underline">Saber más</Link>
            </p>
        </div>
      ...
      <RemissionExportModal
        ...
        onExport={async (options) => {
          ...
          try {
            ...
            const result = await RemissionsService.exportByDateRange(from, to);
