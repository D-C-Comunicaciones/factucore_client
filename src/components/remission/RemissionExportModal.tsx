...
export interface RemissionExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onExport: (options: { rangeType: string; fromDate?: Date; toDate?: Date; isAll?: boolean }) => void;
}

export function RemissionExportModal({ isOpen, onClose, onExport }: RemissionExportModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-primary font-normal text-lg">Exportar remisiones</DialogTitle>
        </DialogHeader>
