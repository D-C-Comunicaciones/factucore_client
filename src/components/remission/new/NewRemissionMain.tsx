...
import { RemissionItemsTable } from "./RemissionItemsTable";
import { NewRemissionOptions } from "./NewRemissionOptions";
...
export function NewRemissionMain({
    mainData,
    catalogData,
    invoiceBuilder,
    typeRemissionId,
    ...
    fixedFields: { warehouse: boolean; seller: boolean; costCenter: boolean; currency: boolean; priceList: boolean };
    ...
    costCentersOptions: { value: string; label: string; description?: string }[];
    taxes: any[];
    ...
    // Preseleccionar el cliente cuando la remisión se está creando a partir de otra (ej. clonar o editar)
    ...
    // Preseleccionar la fecha de vencimiento cuando viene de otra remisión (ej. clonar o editar)
    ...
    return (
        <div className="filter drop-shadow-sm">
            ...
            <div className="mb-8 mt-6">
                <h3 className="text-lg font-semibold text-foreground mb-4">Información de la remisión</h3>
            ...
            {/* ITEMS */}
            <RemissionItemsTable
              remissionBuilder={invoiceBuilder}
              selectedWarehouseId={selectedWarehouseId}
              selectedPriceListId={selectedPriceListId}
                    ...
                    <TooltipProvider delayDuration={200}>
                        <Tooltip>
                            ...
                            <TooltipContent side="right" className="bg-zinc-800 text-white p-2 text-xs max-w-[220px] leading-relaxed">
                                Aplica un descuento o recargo al total de la remisión. Puedes ingresar el valor en porcentaje (%) o como monto fijo ($) y agregar un motivo opcional.
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                </div>
                ...
                <div className="flex flex-col gap-6 mb-8">
                    <div>
                        ...
                        {!isEditingNotes ? (
                            ...
                            >
                                {notes || "Agrega comentarios para aclarar datos de la remisión, serán visibles para tus clientes"}
                            ...
                            <textarea
                                ...
                                placeholder="Agrega comentarios para aclarar datos de la remisión, serán visibles para tus clientes"
