...
function DebitNoteRow({
  ...
  const navigateToDetail = () => router.push(`/expenses/debit-notes/${item.id}`);
...
/* -----------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------- */
interface DebitNotesTableBodyProps {
  loading?: boolean;
  items?: any[];
...
export function DebitNotesTableBody({
  loading = false,
  items = [],
  selection = {},
  onToggleSelection = () => {},
  ...
  const emptyState = (
    <div className="flex h-full flex-col items-center justify-center py-8">
      ...
      <div className="text-center text-xl font-medium text-[#003B73]">
        ¡Cree su primera nota de débito!
      </div>
