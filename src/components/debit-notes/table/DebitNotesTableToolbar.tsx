...
interface DebitNotesTableToolbarProps {
  search: string;
...
export function DebitNotesTableToolbar({
  search,
  onSearchChange,
  activeFilters,
  onAddFilter,
}: DebitNotesTableToolbarProps) {
  ...
  return (
    <div className="min-h-12 px-4 py-2 border-b border-gray-200 flex flex-wrap items-center gap-2">
      ...
      {/* Botón Filtro — se oculta cuando todos los filtros están activos */}
      {!allFiltersActive && (
        <DropdownMenu>
